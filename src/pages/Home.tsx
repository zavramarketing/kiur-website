          ...
          <div className="md:max-w-[55%] relative z-10">
            <div className="pb-14 md:pb-36">
              ...
              <p className="text-base md:text-xl text-background/80 mb-8 md:mb-10 max-w-lg">
                Ведём туры на русском языке, берём на себя всю логистику и показываем природу, от которой захватывает дух.
              </p>
          ...
          <div className="grid md:grid-cols-2 gap-8 items-end">
            ...
            <div className="pb-12 md:pb-16 self-center">
              ...
              <div className="space-y-4 text-primary/80 leading-relaxed">
                ...
                <p>
                  Наша аудитория — активные люди 25–35 лет, живущие в Европе, которым важна хорошая компания и грамотно выстроенный маршрут. Туры ведутся на русском языке.
                </p>
                <p>
                  Мы полностью берём на себя организацию: подбираем комфортное жильё, находим опытных гидов и продумываем логистику. Вам не нужно беспокоиться о деталях — вы просто идёте, дышите свежим воздухом и наслаждаетесь моментом.
                </p>
              </div>
            </div>
          </div>
